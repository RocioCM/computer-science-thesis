...
\begin{figure}[!htb]
	...
	\caption{Salida de la ejecución de las pruebas unitarias del \textit{\gls{endpoint}} de creación de lote en la API backend}
...
La ejecución de las pruebas generó una retroalimentación detallada que se utilizó para identificar y resolver fallos, así como para mejorar la experiencia de usuario (\acrshort{ux}, \textit{\acrlong{ux}}) y el diseño de la interfaz (\acrshort{ui}, \textit{\acrlong{ui}}). Los participantes en su conjunto registraron un total de 63 casos de prueba ejecutados. De los casos ejecutados, los participantes reportaron 16 casos donde el sistema que no funcionaba como esperaban.
