...
La Tabla \ref{tab:testing-comparison} presenta una comparación de estas etapas, destacando sus características y su alcance, como una guía orientativa para comprender la metodología de prueba aplicada.
...
\hline
Pruebas de integración & Antes de cada \par despliegue & Automatizada & Media & Interacción de componentes \\
\hline
Pruebas de sistema & Al finalizar la \par implementación & Manual & Media-Alta & Requerimientos funcionales \\
\hline
Pruebas de aceptación & Al finalizar la \par implementación & Manual & Alta & Experiencia del usuario \\

\end{xltabular}

A continuación, se describen en detalle cada una de las etapas de prueba mencionadas, proporcionando una visión completa del proceso de validación del prototipo. A lo largo de este capítulo se detallará la gestión de las incidencias halladas durante las pruebas. Los errores detectados en cada etapa de prueba fueron registrados y se les dio seguimiento en la herramienta Jira, asegurando que cada problema se resolviera antes de avanzar a la siguiente fase. Adicionalmente, el Apéndice \ref{cp:tests-execution-results} contiene los detalles de la ejecución de cada prueba, los resultados obtenidos y la gestión de las incidencias documentadas.
