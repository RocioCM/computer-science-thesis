...
Como parte de este Trabajo Final se grabó un video demostrativo resumiendo los puntos más importantes del mismo y mostrando el funcionamiento de la plataforma desarrollada desde la perspectiva de un usuario. El mismo se encuentra disponible en el siguiente enlace: [enlace al video] % TODO: add this link.
